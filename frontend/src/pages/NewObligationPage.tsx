...
export function NewObligationPage() {
  ...
  const submit = async () => {
    ...
    if (!creditor || terms.trim().length < 60 || terms.trim().length > 600) { setSubmitError("Choose a creditor and write 60–600 characters of bounded payment terms."); return; }
    setSubmitError(null);
    try {
